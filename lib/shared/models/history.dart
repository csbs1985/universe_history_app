...
class HistoryModel {
  ...
  final bool historyComment;
  final bool historyAnonymous;
  final bool historyEdit;
  final bool historyDelete;
  final String userId;
  ...
  HistoryModel({
    ...
    required this.historyAnonymous,
    required this.historyEdit,
  ...
  static List<HistoryModel> allHistory = [
    new HistoryModel(
      historyId: 'bvjbsbvsu01',
      historyTitle: 'Quando penso no que fiz',
      historyText:
      ...
      historyDate: '2 de janeiro de 2022',
      historyComment: true,
      historyEdit: false,
      historyDelete: false,
      historyAnonymous: false,
      userId: 'fbjfbdj01',
      categories: ['fbjfbdj01', 'gfsdgdg02'],
    ),
    new HistoryModel(
      historyId: 'bvjbsbvsu01',
      historyTitle: 'O dia em que quase morri por três vezes',
      historyText:
